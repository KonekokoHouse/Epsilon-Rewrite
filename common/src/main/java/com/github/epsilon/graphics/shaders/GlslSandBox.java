...
public class GlslSandBox implements AutoCloseable {
    ...
    public void render(Identifier fragmentShader, double mouseX, double mouseY, long startTimeMs) {
        ...
        final int targetWidth = activeTarget != null ? activeTarget.width() : minecraft.gameRenderer.mainRenderTarget().width;
        final int targetHeight = activeTarget != null ? activeTarget.height() : minecraft.gameRenderer.mainRenderTarget().height;
